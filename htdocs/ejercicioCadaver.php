<?php
    ...
    $fraseHidden = $_POST['hidden'];
    $fraseCreada = $_POST['frase_creada'];
    $fraseCompuesta = $fraseHidden . "<br>" . $fraseCreada;
    $id = $_POST['id'];

    // Me conecto a la bd para incluirla
    include("conexion.php");
    $insertar = "INSERT INTO `ejercicio_cadaver_usuario` 
                VALUES (
                    NULL,
                    '$fraseHidden',
                    '$fraseCreada',
            ...
            <section id="ejercicios" class="tipos">
                <div class="tipos-ejer">
                    ...
                    <div class="ejer-resumen">
                        ...
                        <div class="empezar click mostrar" class="formulario">
                        ...
                        <form method="post" action="ver.php">
                            <input type="hidden" name="id" value="<?php
                                echo $_SESSION['id']
                            ?>">
                            <input class="button" type="submit" value="Leer Resultado">
